...
We propose PyTorch implementation of **ConvNeXt**, with a Non-Local Block.
...
The code combines the best of both worlds, to achieve a superior accuracy in classifying lung diseases from Chest X-Rays images. 
